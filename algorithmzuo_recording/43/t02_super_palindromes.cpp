...
public:
    ...
    {
        unsigned long long l = stol(left);
        unsigned long long r = stol(right);
        // l....r  long
        // x根号，范围limit
        unsigned long long limit = (unsigned long long)sqrt((double)r);
    ...
    bool check(unsigned long long ans, unsigned long long l, unsigned long long r)
    {
